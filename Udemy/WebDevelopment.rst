...
In any case the fee is per work done, if the client wants also to add a domain name and a hosting a extra fee should be charged.
It is convenient to upload the site to a test site so the client can see it working, and then upload it to the permanent hosting.
...
Not recommended if you're new, because the client doesn't know how good you are.
Except when you're modifying a small part of a project.
Warning: When you choose an hourly rate you will probably not be able to increase the hourly rate later, take in account the number of hours.
...
The most expensive ones. Security is very importante. No less than $1500 - $2000
With own credit card processing embedded $2500 - $5000
...
Offer three different packages to a prospective client. So the client spend the more he is willing to pay.
