...
![image](../img/arbol_expansion_minima.png)

Hecho el árbol podriamos utilizar el vértice del costo mínimo como la
raiz del árbol.

![image](../img/arbol_expansion_minima_raiz_g.png)
...
![image](../img/arbol_binario_tipos.png)

El árbol degenerado es donde la mayoría de sus nodos tienen solo un
hijo.

![image](../img/arbol_binario_degenerado.png)
...
![image](../img/arbol_binario_recursivo.png)
...
![image](../img/arbol_operaciones_aritmeticas.jpg)
