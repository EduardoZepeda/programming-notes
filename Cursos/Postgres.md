...
-   Esquemas de base de datos en PostgreSQL: Grupo de objetos de base de
    ...
    secuencias).
-   Tablas de base de datos: Estructura que organiza los datos en filas
    y columnas formando una matriz.
...
-   \e Permite abrir un editor de texto plano, escribir comandos y
    ...
    comandos, luego guardar los cambios y cerrar, al cerrar se
    ejecutarán todos los comandos guardados.
...
-   Vista materializada: Hace la consulta una vez y se guarda en
    memoria. Podemos cometer el error de no traer los datos
    actualizados.
...
-   Full el cual es capaz de bloquear las tablas para hacer la limpieza
    y luego la desbloquea. En estas actividades no debemos involucrarnos
...
-   Analize. No hace cambios en la tabla. Solo hace una revisión y la
    muestra.
-   Reindex. Aplica para tablas con numerosos registros con indices,
    como por ejemplo las llaves primarias.
